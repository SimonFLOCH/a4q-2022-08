...
def carrefour():
    ...
    close_cookies = wait.until(expected_conditions.element_to_be_clickable(
    ...
    epicerie_salee = wait.until(expected_conditions.visibility_of_element_located(
        (By.CSS_SELECTOR, ".nav-item__menu-link [alt='Epicerie salée']")))
    ...
    # Clic on buy button
    buy_button = wait.until(expected_conditions.element_to_be_clickable(
    ...
    zip_code = wait.until(expected_conditions.element_to_be_clickable(
        (By.CSS_SELECTOR, "[data-cs-mask=true]")))
